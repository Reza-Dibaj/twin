...
def call_bedrock(conversation: List[Dict], user_message: str) -> str:
    ...
    # Build messages in Bedrock format from conversation history
    messages = []
    ...
    try:
        ...
        # The system prompt is passed via the 'system' parameter — the clean,
        # correct approach that avoids adding a fake user message to the list.
